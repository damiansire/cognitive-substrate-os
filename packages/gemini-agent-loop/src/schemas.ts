export const toolDeclarations = [
    ...
    {
        name: "fetchUrl",
        description: "Obtiene el texto visible de una página web (solo lectura). El dominio debe estar permitido por la política (browserAllowDomains).",
        parameters: {
            type: "OBJECT",
            properties: {
    ...
    },
    {
        ...
        description: "Abre/navega una URL en un navegador real (sesión interactiva persistente). El dominio debe estar permitido por browserAllowDomains.",
        parameters: {
            type: "OBJECT",
